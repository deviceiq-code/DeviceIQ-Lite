...
const bool DEF_Blinds_SaveState = true;
...
class Blinds {
    private:
        ...
        uint32_t EEPROMSaveStateAddress = EEPROM_ADDR_BLINDL_POSITION;
    public:
        Blinds(uint8_t pinButtonOpen, uint8_t pinButtonClose, uint8_t pinSwitchOpen, uint8_t pinSwitchClose, uint32_t EEPROMAddress);
        Blinds(String name, uint8_t pinButtonOpen, uint8_t pinButtonClose, uint8_t pinSwitchOpen, uint8_t pinSwitchClose, uint32_t EEPROMAddress);
        ~Blinds() {}
